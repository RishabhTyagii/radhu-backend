# Generated by Django 5.2.3 on 2026-08-06 16:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('remarks', models.TextField(blank=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='hrms_productions', to=settings.AUTH_USER_MODEL)),
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hrms.employee')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('leave_type', models.CharField(blank=True, choices=[('', '---------'), ('CL', 'CL (Casual Leave)'), ('EL', 'EL (Earned Leave)'), ('LOP', 'LOP (Loss of Pay)')], max_length=10)),
                ('remarks', models.TextField(blank=True)),
